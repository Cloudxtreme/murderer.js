angular.module("common").factory("stats", function ($q, socket) {
  ...
  var service = {
    ...
    analyseDeaths: analyseDeaths,
    analyseUsers: analyseUsers,
    analyseTotal: analyseTotal
  };
  ...
  function getBlockLabel(data, hoursEachBlock) {
  ...
  function analyseDeaths(hoursEachBlock) {
  ...
  function analyseTotal(hoursEachBlock) {
    return $q.all([
